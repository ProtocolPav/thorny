...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> list[ItemModel] | None:
    if response.status_code == 200:
        ...
        for componentsschemas_item_list_model_item_data in _response_200:
            componentsschemas_item_list_model_item = ItemModel.from_dict(componentsschemas_item_list_model_item_data)
