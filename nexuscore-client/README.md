...
```python
from nexuscore.models import MyDataModel
from nexuscore.api.my_tag import get_my_data_model
from nexuscore.types import Response
...
1. Any endpoint which did not have a tag will be in `nexuscore.api.default`
